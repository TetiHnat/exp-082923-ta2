@quote_feature
  Feature: Quote project tests
    ...
    @quote1
    Scenario: Basic from tests
      Given I open url "http://quote-stage.portnov.com"
      Then I wait for 2 sec

    @qoute2
    Scenario: From validation (negative)
      Given I open url "http://quote-stage.portnov.com"
    ...
    @quote2
    Scenario: Successful submission 2
      Given I open url "http://quote-stage.portnov.com"
      Then I should see page title contains "Quote"
      And I click on element with xpath "//input[@id='name']"
      Then element with xpath "//div[@id='nameDialog']" should be displayed
    ...
    @quote2
    Scenario: Successful submission 3
      Given I open url "http://quote-stage.portnov.com"
      Then I should see page title contains "Quote"
      And I click on element with xpath "//input[@id='name']"
      Then element with xpath "//div[@id='nameDialog']" should be displayed
    ...
    @quote2
    Scenario: Successful submission 4
      Given I open url "http://quote-stage.portnov.com"
      Then I should see page title contains "Quote"
      And I click on element with xpath "//input[@id='name']"
      Then element with xpath "//div[@id='nameDialog']" should be displayed
      ...
      Scenario: Portnov
        ...
        Then I click on element with xpath "(//a[@href='https://www.portnov.com/schedule/'])[2]"
        Then I wait for 3 sec
        Then I click on element with xpath "(//a[@href='https://www.portnov.com/'])[5]"
